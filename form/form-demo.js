...
function togglePaymentDetails(e) {
  ...
  const theForm = doccument.querySelector("form");
  ...
  const paymentFields = theForm.querySelectorAll("[data-payment]");
  ...
  if (e.target.value === "creditCard") {
    ...
    paymentFields.forEach((field) => {
      if (field.dataset.payment === "creditCard") {
        field.required = true;
      }
    });
    ...
    paymentFields.forEach((field) => {
      if (field.dataset.payment === "paypal") {
        field.required = true;
      }
    });
  }
